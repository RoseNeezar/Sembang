...
export type PostSnippetFragment = (
  { __typename?: 'Post' }
  & Pick<Post, 'title' | 'text' | 'createdAt' | 'creatorId' | 'id' | 'textSnippet' | 'points' | 'voteStatus'>
  & { creator: (
    { __typename?: 'User' }
...
export type CreatePostMutation = (
  ...
  & { createPost: (
    { __typename?: 'Post' }
    & Pick<Post, 'title' | 'id' | 'text' | 'points' | 'creatorId'>
  ) }
);
...
export type PostQuery = (
  ...
  & { post?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'title' | 'text' | 'createdAt' | 'creatorId' | 'id' | 'points' | 'voteStatus'>
    & { creator: (
      { __typename?: 'User' }
      & Pick<User, 'username' | 'id'>
    ) }
